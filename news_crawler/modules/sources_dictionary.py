...
sources_dictionary = {
	...
	"Retail Detail - Fashion": {
		"country": "Europe",
		"language": "English",
		"landing_urls": ["https://www.retaildetail.eu/en/fashion", "https://www.retaildetail.eu/en/fashion?page=1", "https://www.retaildetail.eu/en/fashion?page=2", "https://www.retaildetail.eu/en/fashion?page=3"],
		"landing_characteristics": '//a[contains(@href, "https")]/@href',
		"article_characteristics": "//p",
		"headline_characteristics": "//h1",
		"published_date_characteristics": "//div[contains(@class, 'date')]",
